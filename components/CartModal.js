...
export default function CardModal() {
  const { showModal, selectedCardList, totalCard, totalPrice } = useSelector(state => state.pokemon);
          ...
          <View style={styles.modalView}>   
            ...
            <View style={styles.bottomView}>
                ...
                <View style={styles.bottomViewOne}>
                    ...
                    <Text style={{marginLeft: 30, color: 'red', fontWeight: 'bold'}}>{totalCard}</Text>
                </View>
